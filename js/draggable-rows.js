            ...
            this.prepareDraggableRow = function ($scope, $element) {
                ...
                var listeners = {
                    ...
                    onDragStartEventListener: function (e) {
                        ...
                        uiGridDraggableRowsCommon.fromIndex = data()
                            .indexOf(uiGridDraggableRowsCommon.draggedRowEntity);
                    ...
                    onDropEventListener: function (e) {
                        ...
                        if (uiGridDraggableRowsCommon.position === uiGridDraggableRowsConstants.POSITION_ABOVE) {
                            if (uiGridDraggableRowsCommon.fromIndex < uiGridDraggableRowsCommon.toIndex) {
                                if ($scope.$parent.$parent.row.grid.api.grouping) {
                                    var grouping = $scope.$parent.$parent.row.grid.api.grouping.getGrouping().grouping.field;
                                    //previous row
                                    var previousRow = data()[uiGridDraggableRowsCommon.toIndex - 1][$scope.$parent.$parent.row.grid.api.grouping.getGrouping().grouping[0].colName];
                                    //current row
                                    var currentRow = data()[uiGridDraggableRowsCommon.toIndex][$scope.$parent.$parent.row.grid.api.grouping.getGrouping().grouping[0].colName];
